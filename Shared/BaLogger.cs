...
namespace CsdbMigration.Shared;

internal class BaLogger(ConcurrentDictionary<DateTime, LogRecord> logs, LogLevel minimumLogLevel = LogLevel.Warning) : ILogger<ICsdbMigrationViewModel>
{
    /// <summary>
    /// The verbosity
    /// </summary>
    private readonly LogLevel _verbosity = minimumLogLevel;
    ...
    ///   <c>true</c> if enabled.
    /// </returns>
    public bool IsEnabled(LogLevel logLevel) => logLevel >= _verbosity;
